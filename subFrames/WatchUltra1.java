...
public class WatchUltra1 extends Products{
   ...
   rows=new String[4][2];
    ...
    rows[1][0]="Display";
    rows[2][0]="Battery";
    rows[3][0]="Material and Finish";
    
    rows[0][1]="S12";
    rows[1][1]="Retina LTPO OLED";
    rows[2][1]="10-15 Days";
    rows[3][1]="Aluminum case";
    ...
    table.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        ...
        img=new ImageIcon("project/picture/ultra1.png");
        picture=new JLabel (img);
        picture.setBounds(20,40,200,400);
        panel.add(picture);

        note=new JLabel("Apple Watch Ultra");
