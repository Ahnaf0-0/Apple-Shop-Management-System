...
public class Airpod2Pro extends Products{
    ...
    public Airpod2Pro() {
        ...
        rows[0][1]="Headphone levels,Accommodatin and Conversation Boost";
        rows[1][1]="Up to 6 hours of listening time with a single charge (up to 5.5 hours with Spatial Audio and Head Tracking enabled)";
        rows[2][1]="Dual beamforming microphones and Touch control ";
        rows[3][1]="Bluetooth 5.3 wireless technology.";
        ...
        img=new ImageIcon("project/picture/apro2.png");
        picture=new JLabel (img);
        picture.setBounds(20,40,200,400);
        panel.add(picture);

        note=new JLabel("Ap2Pro");
